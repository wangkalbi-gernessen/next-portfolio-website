...
const Projects = () => {
  ...
  const webs = [
    {id: 1, title: "Recipe and Calorie Manager", content: "React.js", source: "GitHub", sourceHref: "https://github.com/wangkalbi-gernessen/React_Recipe_and_Calorie_Manager_App"/*, detail: "Detail"*/, image: "https://user-images.githubusercontent.com/37167797/126250654-9f98bb7a-99f0-49b3-9524-f43e68fa4058.png", language: "JavaScript", library: "React.js"/*, picture1: "/blackjack_one.png", picture2: "/blackjack_two.png", description: "Black Jack is card game app. I’ve joined Black Jack project from the very beginning and helped launching the app. My responsibility is developing and maintaining the apps using Java and JavaFX. also code reviewing."*/
    },
  ...
  const mobiles = [
    {id: 1, title: "Recipe and Calorie Manager", content: "iOS project.", source: "GitHub", sourceHref: "https://github.com/Chihori-Suzuki/Recipe-and-Calorie-Manager-App"/*, detail: "Detail"*/, image: "/calorieProj.png", language: "Swift", library: "UIKit"/*, picture1: "/calorie_one.png",picture2: "/calorie_two.png", description: "Recipe and Calorie Manager App is iOS app to research nutrition facts and user’s BMI by inputting ingredients and a meal. I’ve joined Recipe and Calorie Manager App project from the very beginning and helped launching the app. My responsibility is developing and maintaining the apps using Swift and UIKit. also code reviewing."*/},
