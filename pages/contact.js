...
const Contact = () => {
  ...
  return (
    <Container className={classes.content} id="contact">
      ...
      <Typography
        align="center"
        style={{ fontSize: "20px", marginTop: "25px", padding: "0 5px" }}
      >
        Thanks for taking your time to reach out. How can I help you today?
      </Typography>
      ...
      <Grid container style={{ padding: "40px 0" }}>
        ...
        >
          <IconButton
            href="https://github.com/wangkalbi-gernessen"
            target="_blank"
        ...
        >
          <IconButton
            href="https://www.linkedin.com/in/kazunobu-someya-6b44901b6/"
            target="_blank"
            className={classes.btn}
          >
        ...
        >
          <IconButton
            href={`mailto: guizhou08chishui@gmail.com`}
            target="_blank"
            className={classes.btn}
          >
